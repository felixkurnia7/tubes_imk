			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form method="POST" action="{{ route('register') }}" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Username is required">
						...
						<input class="input100" value="{{old('name')}}" type="text" name="name" placeholder="Type your name">
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<input class="input100" type="password" name="password" placeholder="at least 8 characters">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
                    @error('password')
							<strong style="color: red">{{ $message }}</strong>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Password is required">
                        ...
                        <input class="input100" type="password" name="password_confirmation" placeholder="Re-type your password">
                        <span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
					&nbsp;
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is required">
						...
						<input class="input100" type="text" name="alamat" placeholder="Type your address">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
                    @error('alamat')
							<strong style="color: red">{{ $message }}</strong>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is required">
						...
						<input class="input100" type="text" name="no_hp" placeholder="Example: 082164551919">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
                    @error('no_hp')
							<strong style="color: red">{{ $message }}</strong>
					@enderror
					&nbsp;
					<div hidden class="wrap-input100 validate-input m-b-23" data-validate = "Username is required">
						<span hidden class="label-input100">Role</span>
						<input hidden class="input100" type="text" name="role" placeholder="Type your username">
						<span hidden class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
