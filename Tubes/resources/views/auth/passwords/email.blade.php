			...
			<form method="POST" action="{{ route('password.email') }}">
				...
				@endif
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "E-mail is required">
						...
						<input class="input100" type="text" name="email" placeholder="Type your Email here" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autocomplete="email" autofocus>
