            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Daftar Barang (Sewa)</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a class="btn btn-success" href="/admin/barang(sewa)/tambah">Tambah barang</a>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info" href="/admin/barang(sewa)/edit/{{$data->id}}">Ubah</a>
                                                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin?')" href="/admin/barang(sewa)/hapus/{{$data->id}}">Hapus</a></td>
                                        </tr>
                                        @endforeach
