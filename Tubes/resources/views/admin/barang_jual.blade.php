            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Daftar Barang (Jual)</h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info" href="/admin/barang(jual)/edit/{{$data->id}}">Ubah</a>
                                                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin?')" href="/admin/barang(jual)/hapus/{{$data->id}}">Hapus</a></td>
                                        </tr>
                                        </tr>
                                        @endforeach
