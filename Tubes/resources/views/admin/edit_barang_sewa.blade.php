            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Barang (Sewa)</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <form action="/admin/barang(sewa)/edit/update/{{$data->id}}" method="post">
                                    @csrf
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>&nbsp;</td>
                                            <td><input name="nama" value="{{$data->nama}}"></td>
                                        </tr>
                                        @if ($errors->has('nama'))
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>&nbsp;</td>
                                            <td><textarea name="ukuran" cols="23" rows="5">{{$data->ukuran}}</textarea></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>&nbsp;</td>
                                            <td><textarea name="warna" cols="23" rows="3">{{$data->warna}}</textarea></td>
                                        </tr>
                                        @if ($errors->has('warna'))
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>&nbsp;</td>
                                            <td><textarea name="keterangan" cols="23" rows="5">{{$data->keterangan}}</textarea></td>
                                        </tr>
