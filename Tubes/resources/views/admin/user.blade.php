                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if ($data->role == 'admin')
                                            <td>
                                                <center><a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin?')" href="/admin/user/hapus/{{$data->id}}">Hapus</a></center></td>    
                                            @else
                                            <td><center><a class="btn btn-info" href="/admin/user/edit/{{$data->id}}">Ubah</a>
                                                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin?')" href="/admin/user/hapus/{{$data->id}}">Hapus</a></center></td>
                                            @endif
                                        </tr>
                                        @endforeach
