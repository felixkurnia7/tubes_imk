            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Pesanan Barang (Sewa)</h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    @foreach ($result as $data)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data->rents->nama}}</td>
                                            <td>{{$data->banyak}}</td>
                                            <td>{{$data->rents->stok}}</td>
                                            <td>{{$data->harga}}</td>
                                            <td>{{$data->transaksi}}</td>
                                            <td>{{$data->jenis_pesanan}}</td>
                                            <td><img src="../images/{{$data->rents->gambar}}" height="50"></td>
                                            <td>{{$data->created_at}}</td>
                                            <td>{{$data->updated_at}}</td>
                                            @if ($data->status_konfirmasi == '0')
                                                <td colspan="2">Konfirmasi Pembelian?</td>
                                                <td colspan="2"><a class="btn btn-success" href="/admin/pesanan(sewa)/terima/{{$data->id}}/{{$data->rent_id}}">Konfirmasi</a></td>
                                                <td colspan="2"><a class="btn btn-danger" href="/admin/pesanan(sewa)/tolak/{{$data->id}}" onclick="return confirm('Apakah Anda yakin?')">Tolak</a></td>
                                                <td colspan="2"><a class="btn btn-info" href="/admin/pesanan(sewa)/ubah/{{$data->id}}">Ubah</a></td>
                                            @endif
                                            ...
                                            <td colspan="5">Sudah Bayar?
                                                <a class="btn btn-success" href="/admin/pesanan(sewa)/bayar/{{$data->id}}">Sudah</a>
                                                <a class="btn btn-danger" href="/admin/pesanan(sewa)/tolak/{{$data->id}}/{{$data->rent_id}}" onclick="return confirm('Apakah Anda yakin?')">Tolak</a></td>
                                            ...
                                            <td colspan="3">Sudah Dikirim?
                                                <a class="btn btn-success" href="/admin/pesanan(sewa)/kirim/{{$data->id}}">Sudah</a>
                                                <a class="btn btn-danger" href="/admin/pesanan(sewa)/tolak/{{$data->id}}/{{$data->rent_id}}" onclick="return confirm('Apakah Anda yakin?')">Tolak</a></td>
                                            @endif
